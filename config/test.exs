import Config
config :accountex, Oban, testing: :manual
config :accountex, token_signing_secret: "ohBBALCu4R1g+F0HYMg9O6x517MBHNbf"
...
config :accountex, AccountexWeb.Endpoint,
  ...
  secret_key_base: "W+A/bE4wfE3Ndl58MH1DMADUL7WdKHCvJhOIsAa7tInrZxKMziQdszrtgDGH9lbc",
  server: false
